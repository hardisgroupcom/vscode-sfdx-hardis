...
- **DevOps Pipeline: branch window layout** - the author column no longer collapses to an unreadable sliver when the promotion checkboxes are shown, and the footer actions wrap as a row instead of dropping a button under the others and pushing Close out of its corner
