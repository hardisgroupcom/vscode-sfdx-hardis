...
export class Commands {
    ...
    constructor(hardisCommandsProvider: HardisCommandsProvider, hardisStatusProvider: HardisStatusProvider) {
    ...
    registerExecuteCommand() {
        ...
        const disposable = vscode.commands.registerCommand(
            ...
            (sfdxHardisCommand: string) => {
                ...
                if (this.terminalStack.length === 0 || vscode.window.terminals.length === 0) {
                    ...
                    if (process.platform === "win32") {
                        ...
                        const selectedTerminal: string =
                            terminalConfig.integrated?.shell?.windows || terminalConfig.integrated?.defaultProfile?.windows || "";
    ...
    registerRefreshCommandsView() {
        ...
        const disposable = vscode.commands.registerCommand(
            ...
            () => {
                ...
                const toReload = vscode.extensions.all.filter(extension => extension.id === "salesforce.salesforcedx-vscode-core" && extension.isActive === false);
    ...
    registerRefreshStatusView() {
        const disposable = vscode.commands.registerCommand("vscode-sfdx-hardis.refreshStatusView", () =>
    ...
    registerNewTerminalCommand() {
        ...
        const disposable = vscode.commands.registerCommand("vscode-sfdx-hardis.newTerminal", () => {
            vscode.commands.executeCommand(
                "workbench.action.terminal.newInActiveWorkspace",
                "SFDX Hardis"
            );
    ...
    registerOpenExternal() {
        ...
        const disposable = vscode.commands.registerCommand("vscode-sfdx-hardis.openExternal", (url) =>
    ...
    registerShowMessage() {
        // Open external command
        const disposable = vscode.commands.registerCommand("vscode-sfdx-hardis.showMessage", (msg: string, level = 'info') => {
            if (level === 'error') {
