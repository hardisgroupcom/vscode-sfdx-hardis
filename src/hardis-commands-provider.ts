    ...
    let hardisCommands = [
      ...
      },
      {
        ...
        commands: [
          ...
          {
            id: "hardis:org:user:unlink-security-key",
            label: t("unlinkSecurityKeys"),
            tooltip: t("unlinkSecurityKeysTooltip"),
            command: "sf hardis:org:user:unlink-security-key",
            helpUrl: DOCSITE_URL + "/hardis/org/user/unlink-security-key/",
          },
          {
      ...
      },
      {
        ...
        commands: [
          ...
          {
            id: "hardis:org:diagnose:mfa",
            label: t("mfaReadiness"),
            tooltip: t("mfaReadinessTooltip"),
            command: "sf hardis:org:diagnose:mfa",
            helpUrl: DOCSITE_URL + "/hardis/org/diagnose/mfa/",
          },
          {
            id: "hardis:org:diagnose:unsecure-permissions",
            label: t("unsecurePermissions"),
            tooltip: t("unsecurePermissionsTooltip"),
            command: "sf hardis:org:diagnose:unsecure-permissions",
            helpUrl: DOCSITE_URL + "/hardis/org/diagnose/unsecure-permissions/",
          },
          {
            id: "hardis:org:diagnose:usage-entitlements",
            label: t("usageEntitlements"),
            tooltip: t("usageEntitlementsTooltip"),
            command: "sf hardis:org:diagnose:usage-entitlements",
            helpUrl: DOCSITE_URL + "/hardis/org/diagnose/usage-entitlements/",
          },
          {
            id: "hardis:org:diagnose:consumption-alerts",
            label: t("consumptionAlerts"),
            tooltip: t("consumptionAlertsTooltip"),
            command: "sf hardis:org:diagnose:consumption-alerts",
            helpUrl: DOCSITE_URL + "/hardis/org/diagnose/consumption-alerts/",
          },
          {
            id: "hardis:org:diagnose:ai-usage",
            label: t("aiCreditUsage"),
            tooltip: t("aiCreditUsageTooltip"),
            command: "sf hardis:org:diagnose:ai-usage",
            helpUrl: DOCSITE_URL + "/hardis/org/diagnose/ai-usage/",
          },
          {
            id: "org:test:apex",
          ...
          {
            id: "hardis:org:test:agents",
            label: t("runAgentforceTests"),
            command: "sf hardis:org:test:agents",
            tooltip: t("runAgentforceTestsTooltip"),
            helpUrl: DOCSITE_URL + "/hardis/org/test/agents/",
          },
          {
      ...
      },
      {
        ...
        commands: [
          ...
          {
            id: "hardis:doc:data-dictionary",
            label: t("dataDictionary"),
            command: "sf hardis:doc:data-dictionary",
            tooltip: t("dataDictionaryTooltip"),
            requiresProject: true,
            helpUrl: DOCSITE_URL + "/hardis/doc/data-dictionary/",
          },
          {
            id: "hardis:doc:dora-report",
            label: t("doraReport"),
            command: "sf hardis:doc:dora-report",
            tooltip: t("doraReportTooltip"),
            requiresProject: true,
            helpUrl: DOCSITE_URL + "/hardis/doc/dora-report/",
          },
          {
            id: "hardis:doc:release-notes",
            label: t("releaseNotes"),
            command: "sf hardis:doc:release-notes",
            tooltip: t("releaseNotesTooltip"),
            requiresProject: true,
            helpUrl: DOCSITE_URL + "/hardis/doc/release-notes/",
          },
          {
      ...
      },
      {
        ...
        commands: [
          ...
          {
            id: "hardis:mdapi:read",
            label: t("mdapiRead"),
            tooltip: t("mdapiReadTooltip"),
            command: "sf hardis:mdapi:read",
            requiresProject: true,
            helpUrl: DOCSITE_URL + "/hardis/mdapi/read/",
          },
          {
            id: "hardis:mdapi:upsert",
            label: t("mdapiUpsert"),
            tooltip: t("mdapiUpsertTooltip"),
            command: "sf hardis:mdapi:upsert",
            requiresProject: true,
            helpUrl: DOCSITE_URL + "/hardis/mdapi/upsert/",
          },
          {
            id: "package:mergexml",
