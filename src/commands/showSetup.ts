    ...
    async () => {
      ...
      panel.onMessage(async (type: string, data: any) => {
        ...
        if (type === "requestSetupInit") {
          ...
          const autoUpdateDependencies = config.get(
        ...
        // Install or upgrade a dependency
          ...
          if (dependency && typeof dependency.installMethod === "function") {
            ...
            return {
              success: false,
              message: `No installer available for ${dependency.label}`,
            };
          }
          panel.sendMessage({
            type: "installResult",
        ...
        // Show install or fix instructions
          ...
          let message =
            res.message ||
            `Please refer to the documentation for instructions to install or fix ${label}.`;
